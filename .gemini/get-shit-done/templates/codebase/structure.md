...
- Usage: Reference from command with `@/home/baongoc/workspaces/openrag/.gemini/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/baongoc/workspaces/openrag/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/baongoc/workspaces/openrag/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
