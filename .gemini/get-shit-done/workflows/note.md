...
- **Global scope**: `/home/baongoc/workspaces/openrag/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/baongoc/workspaces/openrag/.gemini/notes/`)
...
2. Glob `/home/baongoc/workspaces/openrag/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (/home/baongoc/workspaces/openrag/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/baongoc/workspaces/openrag/.gemini/notes/` — works in any directory
