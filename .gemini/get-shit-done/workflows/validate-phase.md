...
```bash
AUDITOR_MODEL=$(node "/home/baongoc/workspaces/openrag/.gemini/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-nyquist-auditor --raw)
NYQUIST_CFG=$(node "/home/baongoc/workspaces/openrag/.gemini/get-shit-done/bin/gsd-tools.cjs" config get workflow.nyquist_validation --raw)
```
...
```
Task(
  prompt="Read /home/baongoc/workspaces/openrag/.gemini/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/baongoc/workspaces/openrag/.gemini/get-shit-done/templates/VALIDATION.md`
...
node "/home/baongoc/workspaces/openrag/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs(phase-${PHASE}): add/update validation strategy"
```
