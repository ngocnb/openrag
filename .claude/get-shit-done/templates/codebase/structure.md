...
- Usage: Reference from command with `@/home/baongoc/workspaces/openrag/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/baongoc/workspaces/openrag/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/baongoc/workspaces/openrag/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
