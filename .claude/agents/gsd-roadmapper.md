...
Reference full template: `/home/baongoc/workspaces/openrag/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/baongoc/workspaces/openrag/.claude/get-shit-done/templates/state.md`.
