...
Use template from `/home/baongoc/workspaces/openrag/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/baongoc/workspaces/openrag/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/baongoc/workspaces/openrag/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
